...
let UserConnexion = class {
  ...
  render() {
    return (h("form", { onSubmit: (e) => this.envoiConnexion(e) }, h("div", { class: "row mx-3" }, h("div", { class: "col-sm-3" }), h("div", { class: "col-sm-6" }, h("div", { class: "form-group" }, h("h1", { class: "titre" }, "Connexion \u00E0 mon espace"), h("label", { class: "mx-2" }, "Adresse e-mail"), h("input", { type: "email", class: "form-control", name: 'email', placeholder: "exemple@mail.fr", onInput: (event) => this.chargeState(event) })), h("div", { class: "form-group mt-2" }, h("label", { class: "mx-2" }, "Mot de passe"), h("input", { type: "password", class: "form-control", name: 'password', placeholder: "Mon mot de passe", onInput: (event) => this.chargeState(event) })), h("button", { type: "submit", class: "btn mt-2 bg-secondary border" }, "Se connecter")), h("div", { class: "col-sm-3" }))));
  }
};
